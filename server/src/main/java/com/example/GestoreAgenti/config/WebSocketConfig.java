...
public class WebSocketConfig implements WebSocketConfigurer { // Definisce la classe WebSocketConfig che incapsula la logica applicativa.
    ...
    public WebSocketConfig(ChatWebSocketHandler chatWebSocketHandler) { // Costruttore della classe WebSocketConfig che inizializza le dipendenze necessarie.
        this.chatWebSocketHandler = chatWebSocketHandler; // Aggiorna il campo chatWebSocketHandler dell'istanza.
    } // Chiude il blocco di codice precedente.

    @Override // Applica l'annotazione @Override per configurare il componente.
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) { // Definisce il metodo registerWebSocketHandlers che supporta la logica di dominio.
