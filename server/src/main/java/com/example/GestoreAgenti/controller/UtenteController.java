...
/**
 * Gestisce gli utenti applicativi e le relative credenziali.
 */
@RestController
...
public class UtenteController {
    ...
    /** Recupera un utente in base all'identificativo. */
    @GetMapping("/{id}")
