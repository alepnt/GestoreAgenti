...
public class Dipendente extends Persona {
    ...
    public Integer getOrdineRanking() { return ordineRanking; }
    public void setOrdineRanking(Integer ordineRanking) { this.ordineRanking = ordineRanking; }
}
